...
import com.margelo.nitro.pearstarter.PearStarterOnLoad
import java.io.File
...
class MainApplication : Application(), ReactApplication {
  ...
  override fun onCreate() {
    ...
    // Loads libPearStarter and registers all four Nitro HybridObjects (PearStarterPaths,
    // PearStarterRoll, PearStarterBytes, PearStarterEmbed). Nitrogen generates this entry
    // point but never calls it — without it createHybridObject throws
    // "not registered … []".
    PearStarterOnLoad.initializeNative()
  }
}
